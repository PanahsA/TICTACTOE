...
//we could use usePersistedState hook in the following hoc in order to decorate the WrappedComp with the persistedState prop and the function that updates it
